...
const ShapesMenu = ({
  ...
  // Ensure item and activeElement are defined before accessing their properties
  const isDropdownElem = item?.value?.some((elem) => elem?.value === activeElement?.value) || false;
